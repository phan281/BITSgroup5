...
<?php include('header.php')?>
    ...
    <section id="prodetail" class="section-p1">
        <div class="single-pro-image">
            <img src="img/products/death3.jpg" width="100%" id="MainImg" alt="">

            <div class="small-img-group">
                <div class="small-img-col">
                    <img src="img/products/death3.jpg" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/p3.png" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/death2.jpg" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
        ...
        <div class="sing-pro-details">
            ...
            <h4>Description</h4>
            <span>As Sam Bridges, you mission is to deliver hope to humanity by connection the last survivors of a decimated America. Can you reunite the shattered world, one step at a time? </span>
        </div>
    </section>
    ...
    <section id="product1" class="section-p1">
        ...
        <div class="pro-container">
            ...
            <div class="pro" onclick="window.location.href='sproduct_marvel.php'">
                ...
                <div class="des">
                    <span>2022 Best Superhero Game</span>
