...
<?php include('header.php')?>
    ...
    <section id="prodetail" class="section-p1">
        <div class="single-pro-image">
            <img src="img/products/p5.jpg" width="100%" id="MainImg" alt="">

            <div class="small-img-group">
                <div class="small-img-col">
                    <img src="img/products/p5.jpg" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/ffan2.jpg" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/ffan3.jpg" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/ffan4.jpg" width="100%" class="small-img" alt="">
                </div>
            </div>
        </div>
        <div class="sing-pro-details">
            ...
            <select>
                ...
                <option>Final Fantasy VII: Remake Intergrade</option>
            </select>
