...
<?php include('header.php')?>
    ...
    <section id="prodetail" class="section-p1">
        <div class="single-pro-image">
            <img src="img/products/p2.png" width="100%" id="MainImg" alt="">
            ...
            <div class="small-img-group">
                ...
                <div class="small-img-col">
                    <img src="img/products/spider2.jpg" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/spider3.jpg" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/spider4.jpg" width="100%" class="small-img" alt="">
                </div>
            </div>
        </div>
        <div class="sing-pro-details">
            <h3>Home / Superhero - Adventure</h3>
            <h2>MARVEL'S SPIDERMAN: MILES MORALES</h2>
            <h2>$120</h2>
            <select>
                <option>Select version</option>
                <option>Marvel's Spiderman</option>
            </select>
