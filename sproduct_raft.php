...
<?php include('header.php')?>
    ...
    <section id="prodetail" class="section-p1">
        <div class="single-pro-image">
            <img src="img/products/f8.jpg" width="100%" id="MainImg" alt="">
            ...
            <div class="small-img-group">
                ...
                <div class="small-img-col">
                    <img src="img/products/raft2.jpg" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/raft3.jpg" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
                    <img src="img/products/raft4.jpg" width="100%" class="small-img" alt="">
                </div>
            </div>
        </div>
        <div class="sing-pro-details">
            ...
            <select>
                ...
                <option>Raft</option>
                <option>Raft Survival</option>
                <option>Raft: Final chapter</option>
            </select>
