    ...
    <section id="prodetail" class="section-p1">
        <div class="single-pro-image">
            ...
            <div class="small-img-group">
                ...
                <div class="small-img-col">
                    <img src="img/products/stray2.jpg" width="100%" class="small-img" alt="">
                </div>
                <div class="small-img-col">
        ...
        <div class="sing-pro-details">
            <h3>Home / Action - Animal</h3>
            <h2>STRAY</h2>
            <h3>Old Price: $90</h3>
            <h3>New Price: $78 ($12 off)</h3>
            <br>
            <select>
            ...
            <h4>Description</h4>
            <span>Lost, alone and separated from family, a stray cat must untangle an ancient mystery to escape a long-forgotten city.</span>
            <br>
            <br>
            <span>Stray is a third-person cat adventure game set amidst the detailed, neon-lit alleys of a decaying cybercity and the murky environments of its seedy underbelly. Roam surroundings high and low, defend against unforeseen threats and solve the mysteries of this unwelcoming place inhabited by curious droids and dangerous creatures.</span>
        </div>
    </section>
    ...
    <section id="product1" class="section-p1">
        ...
        <div class="pro-container">
            ...
            <div class="pro" onclick="window.location.href='sproduct_dhunger.php'">
                ...
                <div class="des">
                    <span>2022 Most Horror Experience</span>
                    <h5>DREAD HUNGER</h5>
                    <div class="star">
                        <i class="fa-solid fa-star"></i>
                        <i class="fa-solid fa-star"></i>
